...
const EmployeeList = () => {
  ...
  const fetchEmployees = async () => {
    ...
    try {
      const response = await axios.get("https://project-file-backend-1.onrender.com/api/employees");
  ...
  const deleteNotes = async (id) => {
    try {
      await axios.delete(`https://project-file-backend-1.onrender.com/api/employees/delete/${id}`);
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(
        `https://project-file-backend-1.onrender.com/api/employees/update/${editId}`,
        editData
      );
